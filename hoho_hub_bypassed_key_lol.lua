llocal do_check_key = function(key)
    StarterGui:SetCore("SendNotification", {
        Title = "HoHo Hub",
        Text = "Key check bypassed — loading script",
        Duration = 5
    })

    script_key = "bypassed-key"
...
-- Auto trigger it
task.spawn(function()
    task.wait(0.6)   -- small delay so UI appears briefly
    do_check_key("bypassed")
end)locallocal CoreGui = game:GetService("CoreGui")
